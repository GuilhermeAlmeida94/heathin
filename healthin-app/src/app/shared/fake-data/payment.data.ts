...
export const PaymentData: Payment[] = [
    ...
    { patientId: '1', value: 65.5, expirationDate: new Date('2020-12-07') } as Payment,
    { patientId: '1', value: 65.5, expirationDate: new Date('2021-01-06') } as Payment,
    { patientId: '1', value: 65.5, expirationDate: new Date('2021-02-05') } as Payment,
    { patientId: '1', value: 65.5, expirationDate: new Date('2021-03-04') } as Payment,
    { patientId: '1', value: 65.5, expirationDate: new Date('2021-04-03') } as Payment,
    { patientId: '1', value: 65.5, expirationDate: new Date('2021-05-02') } as Payment,
